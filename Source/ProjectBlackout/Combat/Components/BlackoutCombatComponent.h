// ─── 구현 내역 ───────────────────────
//  - 김민영: 전투 컴포넌트 코어(로드아웃·장착·무기 스왑, 조준/사격 입력 분기, 연사, 탄퍼짐·반동 틱, 무기 부착/홀스터 오버라이드, HUD 이벤트) 구현
//  - 허혁: NotifyState 기반 근접 공격 윈도우/콤보 입력 및 데미지 숫자 UI 추적·로컬 예측(무기 숨김 오버라이드) 구현
//  - 최승현: 캐릭터 교체 인프라·무기 액터 정리 및 슬롯별 무기 접근자(자원 회복용) 구현
// ──────────────────────────────────────
