// ─── 구현 내역 ───────────────────────
//  - 최승현: 캐릭터 선택 UI 입력·렌더링 전환·Ready RPC / 화면 전환 페이드·readiness 게이트 / 닉네임 서버 반영 / 인게임 메뉴·타이틀 복귀 / 3인칭 카메라 폴리시
//  - 김민영: 전투 GA 입력 라우팅(사격/조준/장전/무기 교체/소모품/유물) / 사망 후 관전 모드·대상 순환 / 항복 투표 입력 / HUD 초기화
//  - 허혁: 디버그 치트·스턴 게이지 디버그 / 데미지 숫자 UI / DLSS·ESC 메뉴 / Revive·다운·피격 입력 처리
// ──────────────────────────────────────
