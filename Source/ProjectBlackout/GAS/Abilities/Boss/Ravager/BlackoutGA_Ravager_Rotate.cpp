...
#include "GAS/Abilities/Boss/Ravager/GA_Ravager_Rotate.h"

#include "BlackoutGameplayTags.h"
#include "BORavagerBoss.h"
#include "Abilities/Tasks/AbilityTask.h"

void UGA_Ravager_Rotate::PreActivateAbility(const FGameplayAbilitySpecHandle Handle,
...
FGameplayTag UGA_Ravager_Rotate::SelectMontageTag(const FGameplayEventData* TriggerEventData) const
{
	if (!TriggerEventData)
	{
