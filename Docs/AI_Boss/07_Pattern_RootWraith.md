...
이 의도가 후속 모든 결정 (HP 320, 헤드샷 1발 즉살, 페어 1쌍씩 4마리, 일반 처치 시 드랍 없음) 의 근거.
...
- 사운드 / 알림 신호 (텔레포트 등장 청각 단서)
- 페어 한 마리 사망 시 남은 한 마리 행동 변화
- 약점 hitbox 본 이름 / 콜리전 모양 / 데미지 배수 확정
- 헤드 노출 더 명확히 할 시각 보강 (조준 시 약점 강조 VFX 등)
